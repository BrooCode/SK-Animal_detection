...
class TFDetector:
    ...
    def generate_detections_one_image(self, image, image_id,
        ...
        try:
            ...
            box = [[]]
            try:
                for i in range(len(detections_cur_image)):
                    box.append(detections_cur_image[i]["bbox"])
                print(box)    
            except:
                print("out of range!!!!!")
...
def load_and_run_detector(image_file):
    ...
    result,flag,box = tf_detector.generate_detections_one_image(image, image_file)
    print(result)
